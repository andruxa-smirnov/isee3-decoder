int fano(unsigned long *metric, unsigned long *cycles,
	...
	unsigned int nbits,int mettab[2][256],int delta,
	 unsigned long maxcycles,unsigned long long encstate,unsigned long long tailbits);
unsigned long long encode(unsigned char *symbols,const unsigned char *data,unsigned int nbytes,unsigned long long encstate);
